<%@ Page Title="" Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true"
    CodeFile="employees-with-supervisors.aspx.cs" Inherits="misc_sample_employess_with_supervisors" %>
                    ...
                    <tr>
                        <td>
                            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                DataSourceID="ObjectDataSource1" SkinID="GridView">
                                <Columns>
                            ...
                            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="DeleteEmployee"
                                SelectMethod="GetAllEmployeesWithSupervisors" TypeName="Eisk.DataAccess.Employee">
                                <DeleteParameters>
