<%@ Page Language="C#" MasterPageFile="~/master/default.master" AutoEventWireup="true"
    ...
    MetaKeywords="ASP.NET, Employee,Details" MetaDescription="In this page, you will be able to see details of an employee." %>

<%@ Register Assembly="Eisk.DataAccess" Namespace="Eisk.UiLayer" TagPrefix="CustomControl" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceholder1" runat="Server">
                ...
                <tr>
                    ...
                    <td class="datafieldTBL">
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Required"
                            ControlToValidate="ddlCountry" InitialValue=""></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td class="captionTBL">
    ...
    <asp:ObjectDataSource ID="odsEmployeeDetails" runat="server" TypeName="Eisk.DataAccess.Employee"
        ...
        DataObjectTypeName="Eisk.DataAccess.Employee" OnSelecting="OdsEmployeeDetails_Selecting"
        OnUpdated="OdsEmployeeDetails_Updated" OnInserted="OdsEmployeeDetails_Inserted">
        <UpdateParameters>
