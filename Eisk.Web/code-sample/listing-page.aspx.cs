...
public partial class Code_Sample_Listing_Page : System.Web.UI.Page
{
    ...
    protected void ButtonDeleteSelected_Click(object sender, System.EventArgs e)
    {
        try
        {
            ...
            if (Eisk.DataAccess.Employee.DeleteEmployees(employeeIDsToDelete) == false)
    ...
    protected void odsEmployeeDetails_Deleted(object sender, ObjectDataSourceStatusEventArgs e)
    {
        //getting the result
