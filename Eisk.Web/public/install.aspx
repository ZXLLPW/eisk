    ...
    <table id="tblOuter" class="contentcontainerTBL" summary="table1 summary info" width="100%">
        <tr>
            <td>
                ...
                <p>
                    For full automation experience, use ".\SQLEXPRESS" as the database server. Otherwise install
                    the database and configure the database connection string in config files manually.
                    In later version of this starter kit will support for database installation autmation
                    for any server.
                </p>
                ...
                <fieldset>
                    ...
                    <asp:Panel runat="server" ID="pnlDbName" Visible="false">
                        <label for="name">
                            your database name</label><asp:TextBox Text="test_EmployeeInfo_SK_4_0" runat="server"
