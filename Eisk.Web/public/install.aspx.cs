...
public partial class public_install : System.Web.UI.Page
{
    ...
    {
        if (SqlScriptUtility.CreateDatabase(txtDbName.Text, connectionString))
        {
            ...
            SqlScriptUtility.CreateDatabase(txtDbName.Text, newConnectionString);
    ...
    protected void buttonInstall_Click(object sender, EventArgs e)
    {
        try
        {
            SqlScriptUtility.RunScript(Server.MapPath("~") + @".\..\Eisk.Database\Basic Scripts\Schema\Create-Schema.sql");
